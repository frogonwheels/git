...
/*
 * This is based on resolve_symlink in lockfile.c with support for widechars and
 * also much better support at resolving symlinks when the path alone the way
 * has symlinks.
 *
